...
public class PoiUtils {
	...
	public static void writeToDoc(String templetDocPath, String targetDocPath, Map<String,String> dataMap){
		try
		{
			...
			writeToDoc(in,targetDocPath,dataMap,null);
		}
		catch(IOException e)
		{
			e.printStackTrace();
	 ...
	 * @param targetDocPath 生成的目标文件的完整路径
	 * @param dataMap 替换的数据*/
	public static void writeToDoc(InputStream templetDocInStream, String targetDocPath, Map<String,String> dataMap,String picPath){
		try
		{
			XWPFDocument doc=new XWPFDocument(templetDocInStream);
			//得到模板doc文件的HWPFDocument对象
...
//			List<Picture> pic_list= HDoc.getPicturesTable().getAllPictures();
//			for (int i=0;i<pic_list.size();i++) {
//				Picture pic = pic_list.get(i);
////                byte t[] =  pic.getContent();
//                FileOutputStream out_0=new FileOutputStream(picPath,true);
//                byte t[] = new byte[1024];
//                out_0.write(t);
//				pic.writeImageContent(out_0);
//			}
			//写到另一个文件中
